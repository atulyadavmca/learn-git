...
@Component({
  selector: 'app-cghs-dashboard',
  templateUrl: './cghs-dashboard.component.html',
  styleUrls: ['./cghs-dashboard.component.css']
})
export class CghsDashboardComponent implements OnInit {
  ...
  cghsamountlevel:any;
  ddlcghsamountlevel:any="Claim Recieved";

  CGHSAmountLevel_arr:any;
  CGHSAmountLevel_Text_arr:any;
  CGHSAmountLevel_valueCR_arr:any;
  CGHSAmountLevel_valueCP_arr:any;
  CGHSAmountLevelBars:any;
  levelToggelAmountLevel:any="C";


  CGHSLevelTrends_arr:any;
  CGHSTotal_r_arr:any;
  CGHSTotal_amount_r_arr:any;
  CGHSTotal_d_arr:any;
  CGHSTotal_amount_d_arr:any;
  CGHS_dt_arr:any;
  CGHSLevelTrendsBars:any;
  CGHSLeveltype:any;
  CGHSLevelRpttype:any;
  CGHSLevel_Count_Amount:any;
  ...
  @ViewChild('CGHSAmountLevelChart') CGHSAmountLevelChart:any;
  @ViewChild('CGHSLevelTrendsChart') CGHSLevelTrendsChart:any;
  @ViewChild('modal') modal:any;
  

  pageData = {
    cghspatinetdata: [] as any[]
  ...
  constructor(public apiService: ApiserviceService,
    public router: Router) { 
      ...
      this.CGHSLeveltype="CGHS";
      this.CGHSLevelRpttype="T";
      this.CGHSLevel_Count_Amount="C";
    }
  ...
  ngOnInit(): void {
    ...
    this.GetCGHSUserAgeData("","","","C");
    this.GetCGHSAmountAgeData("","","","C");
    ...
    this.GetStateMaster();
    this.GetUploadDate();
    this.GetCGHSAmountLevelMaster();
    this.GetCGHSAmountLevel("",this.levelToggelAmountLevel,"","","");

   this.GetCGHSLevelTrends(this.CGHSLeveltype,this.CGHSLevelRpttype,"","","",this.CGHSLevel_Count_Amount);
  ...
  bindHosp(event:any)
   { 
    ...
    for(var i in this.districtlist)
      {
        if(this.districtlist[i]["value"]==val)
        {
         
          this.district_name=this.districtlist[i]["text"];
        }
      } 
   ...
   onToggle(id:any)
  {
    ...
    let cghsuserdatacount = <HTMLScriptElement>document.getElementById('cghsuserdatacount');
      ...
      let cghsuseragedatacount = <HTMLScriptElement>document.getElementById('cghsuseragedatacount');
      let cghsuseragedataamount = <HTMLScriptElement>document.getElementById('cghsuseragedataamount');
      let CLSummaryCR1 = <HTMLScriptElement>document.getElementById('CLSummaryCR1'); 

      let cghsamountagedatacount = <HTMLScriptElement>document.getElementById('cghsamountagedatacount');
      let cghsamountagedataamount = <HTMLScriptElement>document.getElementById('cghsamountagedataamount');
      let CLSummaryCR2 = <HTMLScriptElement>document.getElementById('CLSummaryCR2'); 
    ...
    if(el.ariaPressed=="false")
    {
      ...
      if(id=="togguseragedata")
      {
        cghsuseragedatacount.style.display="none";
        cghsuseragedataamount.style.display="block";
        CLSummaryCR1.style.display="inline-block";
      }

      if(id=="toggamountagedata")
      {
        cghsamountagedatacount.style.display="none";
        cghsamountagedataamount.style.display="block";
        CLSummaryCR2.style.display="inline-block";
      }
    ...
    else
    {
      ...
      if(id=="togguseragedata")
      {
        cghsuseragedatacount.style.display="block";
        cghsuseragedataamount.style.display="none";
        CLSummaryCR1.style.display="none";
      }

      if(id=="toggamountagedata")
      {
        cghsamountagedatacount.style.display="block";
        cghsamountagedataamount.style.display="none";
        CLSummaryCR2.style.display="none";
      }
...
getReport()
{
  ...
  this.GetCGHSUserAgeData(this.ddlstate,this.ddldistrict,this.ddlhosp,"C");
  this.GetCGHSAmountAgeData(this.ddlstate,this.ddldistrict,this.ddlhosp,"C");
  //this.CGHSLDTDBars.destroy();
  ...
  this.CGHSAmountLevelBars.destroy();
  this.GetCGHSAmountLevel("",this.levelToggelAmountLevel,this.ddlstate,this.ddldistrict,this.ddlhosp); 

  return false;
}
  GetStateMaster()
  {
    this.pmjReq.type=this.encrdecrdervice.encrypted('SMCGHS');  
    this.pmjReq.state_code="";
    this.pmjReq.district_code="";
    this.pmjReq.rpttype="";     
   this.apiService.GetStateDist(this.pmjReq).subscribe((response) => { 
  ...
  getDistrict(state_code:any)
  {
    ...
    this.pmjReq.type=this.encrdecrdervice.encrypted('DMCGHS');  
    if(state_code!="")
    this.pmjReq.state_code=this.encrdecrdervice.encrypted(state_code);
    else
    this.pmjReq.state_code="";
    ...
    for(var i in this.stateList)
      {
        ...
        {
          //console.log("this.stateList[i][state_name]" + this.stateList[i]["text"]);
  ...
  GetCGHSTopHeadData(state_code:any,district_code:any,hosp_code:any)
   {
      ...
      if(response['status']=="true")
      {
        ...
        this.rejected_count=this.getCommaValue(this.cghslistdata[0]['rejected_count']);
        this.rejected_amount=this.cghslistdata[0]['rejected_amount']; 
        
        var totalTDA=Number(this.cghslistdata[0]['pending_hcos_amount'])+Number(this.cghslistdata[0]['pending_nha_amount'])+Number(this.cghslistdata[0]['pending_cghs_amount'])+Number(this.cghslistdata[0]['pending_pfms_amount'])+Number(this.cghslistdata[0]['claim_paid_amount'])+Number(this.cghslistdata[0]['rejected_amount']);
   ...
   GetCGHSUserAgeData(state_code:any,district_code:any,hosp_code:any,toggelType:any)
   {
    ...
    let cghsuseragedatacount = <HTMLScriptElement>document.getElementById('cghsuseragedatacount');
      ...
      if(response['status']=="true")
      {
        this.cghsuseragedata=[];
        this.cghsuseragedata=response['list'];      
      }
      });    
   }

   GetCGHSAmountAgeData(state_code:any,district_code:any,hosp_code:any,toggelType:any)
   {
    ...
    let cghsamountagedatacount = <HTMLScriptElement>document.getElementById('cghsamountagedatacount');
      ...
      if(response['status']=="true")
      {
        this.cghsamountagedata=[];
        this.cghsamountagedata=response['list'];      
      }
      });    
   }
      ...
      // this.pending_pfms_amount_arr=[];
       ...
       this.cghsstatewise=this.cghslistdata;
            for(var i in this.cghslistdata)
            {
              ...
              this.cghs_state_name_arr1.push(this.cghslistdata[i]['state_name']);
              if(rpttype=="C")
              {
      ...
      this.CGHSSTDBars = new Chart(this.CGHSSTDChart.nativeElement, {
        ...
        data: {
          ...
          datasets: [/*{  
            ...
            backgroundColor:'#7F9FC3', // array should have same number of elements as number of dataset
            //borderRadius: Number.MAX_VALUE,
            borderSkipped: false,
            barThickness:14
          },{  
            ...
            backgroundColor:'#49BAD3', // array should have same number of elements as number of dataset
            //borderRadius: Number.MAX_VALUE,
            borderSkipped: false,
            barThickness:14
          },{  
            ...
            backgroundColor:'#C9B499', // array should have same number of elements as number of dataset
            borderSkipped: false,
            barThickness:14
          },{  
            label:'Claim Paid'  ,        
            data: this.claim_paid_arr,
            backgroundColor:'#E17677', // array should have same number of elements as number of dataset
            //borderRadius: Number.MAX_VALUE,
            //borderRadius:3,
            borderSkipped: false,
            barThickness:14
          ...
          onClick: (evt, item) => {
            let index = item[0]["index"];
                ...
                if(this.CGHSDTState_District=="S")
                {
                 ...
                 this.state_name =this.cghs_state_name_arr1[index];               
                }
                else if(this.CGHSDTState_District=="D")
                {
                 ...
                 this.district_name =this.cghs_state_name_arr1[index];               
                }
                else
                {
                 this.CGHSSTDBars.destroy();
   ...
   GetCGHSAmountLevel(type:any,rpttype:any,state_code:any,district_code:any,hosp_code:any)
   {  
    let CLSummaryCR3 = <HTMLScriptElement>document.getElementById('CLSummaryCR3'); 
    if(rpttype=="C")  
        CLSummaryCR3.style.display="none";
    else
        CLSummaryCR3.style.display="inline-block";
    ...
    this.cghsdatareq.type=type;  
      ...
      this.cghsdatareq.hosp_code=hosp_code;
      this.cghsdatareq.rpttype=rpttype;
      this.apiService.GetCGHSAmountLevel(this.cghsdatareq).subscribe((response) => {    
        //console.log("Summary111");          
      //console.log(response);          
      if(response['status']=="true")
      {
        this.CGHSAmountLevel_arr=[];
        this.CGHSAmountLevel_Text_arr=[];
        this.CGHSAmountLevel_valueCR_arr=[];
        this.CGHSAmountLevel_valueCP_arr=[];
       
        this.CGHSAmountLevel_arr=response['list'];
            for(var i in this.CGHSAmountLevel_arr)
            {
              
                this.CGHSAmountLevel_Text_arr.push(this.CGHSAmountLevel_arr[i]['text']);                
                this.CGHSAmountLevel_valueCR_arr.push(this.CGHSAmountLevel_arr[i]['cr']);   
                this.CGHSAmountLevel_valueCP_arr.push(this.CGHSAmountLevel_arr[i]['cp']);                    
               
            } 

      this.CGHSAmountLevelBars = new Chart(this.CGHSAmountLevelChart.nativeElement, {
        type: 'line',        
        data: {
          labels: this.CGHSAmountLevel_Text_arr,
          datasets: [{
            label:'Claims Paid'  ,        
            data: this.CGHSAmountLevel_valueCP_arr,
            backgroundColor: 'rgba(197, 237, 192,.7)',//'rgb(38, 194, 129)', // array should have same number of elements as number of dataset
            borderColor: 'rgba(197, 237, 192,.7)',// array should have same number of elements as number of dataset
            borderWidth: 1.5,
            fill:true,
            pointRadius:2,
            pointBorderColor:'#EBA425',
          },{
            label:'Claim Recieved'  ,        
            data: this.CGHSAmountLevel_valueCR_arr,
            backgroundColor: 'rgba(243, 212, 212,.7)',//'rgb(38, 194, 129)', // array should have same number of elements as number of dataset
            borderColor: 'rgba(243, 212, 212,.7)',// array should have same number of elements as number of dataset
            borderWidth: 1.5,
            fill:true,
            pointRadius:2,
            pointBorderColor:'#EBA425',
              ...
              callbacks: {
                title: function(context){
                  ...
                  label: function(context) {
                      ...
                      if(rpttype=="A")
                      {
                        var str=String(Number(context.parsed.y).toFixed(2));
                        var splitted = str.split(".", 2); 

                        var nStr=String(splitted[0]);
                        var num;
                          if(nStr.length==4)
                          num=nStr.substring(0,1)+","+nStr.substring(1,nStr.length)
                          else if(nStr.length==5)
   ...
   GetCGHSLevelTrends(type:any,rpttype:any,state_code:any,district_code:any,hosp_code:any,typeto:any)
   {  
      this.cghsdatareq.type=type;  
      this.cghsdatareq.state_code=state_code;
      this.cghsdatareq.district_code=district_code;
      this.cghsdatareq.hosp_code=hosp_code;
      this.cghsdatareq.rpttype=rpttype;
      this.apiService.GetCGHSLevelTrends(this.cghsdatareq).subscribe((response) => {    
                 
      if(response['status']=="true")
      {
        this.CGHSLevelTrends_arr=[];
        this.CGHSTotal_r_arr=[];
        this.CGHSTotal_amount_r_arr=[];
        this.CGHSTotal_d_arr=[];
        this.CGHSTotal_amount_d_arr=[];
        this.CGHS_dt_arr=[];
      
        this.CGHSLevelTrends_arr=response['list'];
            for(var i in this.CGHSLevelTrends_arr)
            {
              
                this.CGHS_dt_arr.push(this.CGHSLevelTrends_arr[i]['dt']);                
                this.CGHSTotal_r_arr.push(this.CGHSLevelTrends_arr[i]['total_r']);   
                this.CGHSTotal_amount_r_arr.push(this.CGHSLevelTrends_arr[i]['total_amount_r']); 
                this.CGHSTotal_d_arr.push(this.CGHSLevelTrends_arr[i]['total_d']);   
                this.CGHSTotal_amount_d_arr.push(this.CGHSLevelTrends_arr[i]['total_amount_d']);                    
               
            } 
            if(typeto=="C")
            {
      this.CGHSLevelTrendsBars = new Chart(this.CGHSLevelTrendsChart.nativeElement, {
        type: 'line',        
        data: {
          labels: this.CGHS_dt_arr,
          datasets: [{
            label:'Claims Disposed'  ,        
            data: this.CGHSTotal_d_arr,
            backgroundColor: 'rgba(120, 176, 113,.7)',//'rgb(38, 194, 129)', // array should have same number of elements as number of dataset
            borderColor: 'rgba(120, 176, 113,.7)',// array should have same number of elements as number of dataset
            borderWidth: 2.5,
            //fill:true,
            pointRadius:2,
            pointBorderColor:'rgba(120, 176, 113)',
          },{
            label:'Claim Recieved'  ,        
            data: this.CGHSTotal_r_arr,
            backgroundColor: 'rgba(181, 134, 134,.7)',//'rgb(38, 194, 129)', // array should have same number of elements as number of dataset
            borderColor: 'rgba(181, 134, 134,.7)',// array should have same number of elements as number of dataset
            borderWidth: 2.5,
            //fill:true,
            pointRadius:2,
            pointBorderColor:'rgba(181, 134, 134)',
          }
          ]
      ...
      if(typeto=="A")
      {
        this.CGHSLevelTrendsBars = new Chart(this.CGHSLevelTrendsChart.nativeElement, {
          ...
          data: {
            ...
            datasets: [{
              label:'Claims Disposed'  ,        
              data: this.CGHSTotal_amount_d_arr,
              backgroundColor: 'rgba(120, 176, 113,.7)',//'rgb(38, 194, 129)', // array should have same number of elements as number of dataset
              borderColor: 'rgba(120, 176, 113,.7)',// array should have same number of elements as number of dataset
              borderWidth: 2.5,
              //fill:true,
              ...
              label:'Claim Recieved'  ,        
              data: this.CGHSTotal_amount_r_arr,
              backgroundColor: 'rgba(181, 134, 134,.7)',//'rgb(38, 194, 129)', // array should have same number of elements as number of dataset
              borderColor: 'rgba(181, 134, 134,.7)',// array should have same number of elements as number of dataset
              borderWidth: 2.5,
              //fill:true,
                  ...
                  title: function(context){
                    ...
                    label: function(context) {
                        ...
                        if(typeto=="A")
                        {
                          ...
                          var num1;
                          num1=Number(Number(context.parsed.y));
                          if(num1>0)    
                          num1=String((num1/10000000).toFixed(2));
                          else
                          num1=0.00; 
  ...
  GetCGHSStateLevelWise(type:any,rpttype:any,state_code:any,district_code:any,hosp_code:any,togtype:any)
   ...
   GetCGHSPatientData(state_code:any,district_code:any,hosp_code:any) {
    let overlay_search= <HTMLScriptElement>document.getElementById('overlay_search_cghs');
    ...
    this.apiService.GetCGHSPatientData({
      ...
      this.pageData.cghspatinetdata = resp.list;
      overlay_search.style.display="none";
      let divActiveUser = <HTMLScriptElement>document.getElementById('divCGHSPatientDtls'); 
    divActiveUser.style.display="block";
      if(resp.list.length) {
        ...
        this.totalData.cghspatinetdata = [totalData]
      } else {
        this.totalData.cghspatinetdata = []
      }
      
      
      $('#abcdefgh').DataTable().clear().destroy();
  ...
  {    
    this.GetCGHSPatientData(state_code,district_code,hosp_code);
  ...
  GetCGHSAmountLevelMaster()
  {
    this.pmjReq.type=this.encrdecrdervice.encrypted('CGHSLEVELM');  
    this.pmjReq.state_code="";
    this.pmjReq.district_code="";
    this.pmjReq.rpttype="";     
   this.apiService.GetStateDist(this.pmjReq).subscribe((response) => { 
     //console.log(response);            
       if(response['status']=="true")
   {
     this.cghsamountlevel=response['list'];
     //console.log(this.stateList);
   }
   });
  ...
  onLevelToggle(id:any)
  {
    ...
    if(el.ariaPressed=="false")
    {
      this.levelToggelAmountLevel="A";
    }
    else
    {
      this.levelToggelAmountLevel="C";
    }
    this.CGHSAmountLevelBars.destroy();
    this.GetCGHSAmountLevel("",this.levelToggelAmountLevel,this.ddlstate,this.ddldistrict,this.ddlhosp); 
  }
  getOption(type:any)
  {
    this.CGHSLeveltype=type;
    this.CGHSLevelTrendsBars.destroy();
    this.GetCGHSLevelTrends(this.CGHSLeveltype,this.CGHSLevelRpttype,this.ddlstate,this.ddldistrict,this.ddlhosp,this.CGHSLevel_Count_Amount);
  }

  CGHSLTDclickme(type:any){
    
    this.CGHSLevelRpttype=type;
    this.CGHSLevelTrendsBars.destroy();
    this.GetCGHSLevelTrends(this.CGHSLeveltype,this.CGHSLevelRpttype,"","","",this.CGHSLevel_Count_Amount);
    
    let elementW = <HTMLScriptElement>document.getElementById('CGHSLTDW');
    let elementT = <HTMLScriptElement>document.getElementById('CGHSLTDT');
    //let elementA = <HTMLScriptElement>document.getElementById('CGHSLTDA');
    //console.log(elementW);
    if(type=='W')
    {      
      elementW.className = 'active';
